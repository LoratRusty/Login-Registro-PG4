        ...
        <div class="col-lg-10 col-xl-9 mx-auto">
          <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
            ...
            <div class="card-body p-4 p-sm-5">
              ...
              <h1 class="card-title text-center mb-2 fw-light fs-2"><strong>Registro de Estudiantes</strong></h1>
              <h3 class="card-title text-center mb-5 fw-light fs-3">Universidad Bicentenaria de Aragua</h3>
              ...
              <!-- Teléfono Celular: -->
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="telefono" placeholder="Teléfono Celular:" name="telefono" required autofocus>
                  <label for="telefono">Teléfono Celular:</label>
                </div>
              <!-- Carrera -->
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="carrera" placeholder="Carrera:" name="carrera" required autofocus>
